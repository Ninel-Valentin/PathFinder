                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        switch (canvasCb.getSelectedItem().toString()) {
                                ...
                                for (Component obj : cardPanel.getComponents()) {
                                    if (obj.getName() != null)
                                        if (obj.getName() == "graphCb_REMOVABLE") {
                                            String type = ((JComboBox<String>) (obj)).getSelectedItem().toString();
                                            switch (type) {
                                                case "Unoriented Graph":
                                                    graphType = new Graph.UnorientedGraph();
                                                    break;
                                                case "Oriented Graph - Digraph":
                                                    graphType = new Graph.OrientedGraph();
                                                    break;
                                                default:
                                                    System.err.println(
                                                            "ERROR: \"" + type
                            ...
                            case "Grid Canvas":
                                    ...
                                    if (obj.getName() != null) {
                                        if (obj.getName() == "rowInput_REMOVABLE") {
                                            size.setSize(Integer
                                                    .valueOf(((JFormattedTextField) (obj)).getValue().toString()),
                                                    size.height);
                                        }
                                ...
                                secondaryDataset = size;
                                break;
                            default:
                                System.err.println(
                                        "ERROR: \"" + canvasCb.getSelectedItem() + "\" is not a valid setting!");
                        }
                        WindowService.OpenDefaultWindow(graphType, secondaryDataset,algorithmCb.getSelectedItem().toString());
                        window.dispose();
                    }
                });
                        ...
                        if (e.getStateChange() == 1) {
                            switch (e.getItem().toString()) {
                                case "Graph Canvas":
                                    ...
                                    graphGridTitle.setText("Grid size (rows & columns)");
                                ...
                                case "Grid Canvas":
                                    ...
                                    // TODO: add check for inputs to have values over 2
                                    JFormattedTextField rowInput = new JFormattedTextField(createFormatter("##"));
                                    ...
                                    // TODO: add check for inputs to have values over 2
                                    JFormattedTextField colInput = new JFormattedTextField(createFormatter("##"));
                                    ...
                                    break;
                                default:
                                    System.err.println("ERROR: \"" + e.getItem() + "\" is not a handled canvas type");
                            }
    ...
    private static JButton CreateToolboxButton(final String iconName, final JPanel canvas) {
        ...
        button.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                Image cursorIcon = toolkit.getImage("./data/img/cursor/images/Cursor_" + iconName + ".png");
